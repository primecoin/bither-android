...
package org.primer.charts.view;

import static org.primer.charts.utils.Utils.formatDoubleToString;
...
public class MACandleStickChart extends CandleStickChart {
    ...
    protected void beginRedrawOnTouch(float clickPostX) {
        ...
        PrimerOHLCEntity primerOHLCEntity = (PrimerOHLCEntity) stickData
                .get(index);
        double close = primerOHLCEntity.getClose();
        ...
        if (getTouchEventResponse() != null) {
            ...
            Object[] objs = new Object[]{primerOHLCEntity.getDate(),
                    formatDoubleToString(primerOHLCEntity.getOpen()),
                    formatDoubleToString(primerOHLCEntity.getHigh()),
                    formatDoubleToString(primerOHLCEntity.getLow()),
                    formatDoubleToString(primerOHLCEntity.getClose()), tenLine,
                    thirtyLine,
                    formatDoubleToString(primerOHLCEntity.getVolume())};
