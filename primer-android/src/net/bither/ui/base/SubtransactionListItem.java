...
public class SubtransactionListItem extends FrameLayout implements View.OnClickListener {
    ...
    public static boolean isMessage(String address) {
        return Utils.compareString(address, PrimerApplication.mContext.getString(R.string
                .address_cannot_be_parsed)) || Utils.compareString(address,
                PrimerApplication.mContext.getString(R.string.input_coinbase)) || Utils
                .compareString(address, PrimerApplication.mContext.getString(R.string
                        .address_mine));
    }
