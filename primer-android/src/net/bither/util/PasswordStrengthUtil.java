...
public class PasswordStrengthUtil {
    ...
    public enum PasswordStrength {
        ...
        public String getName() {
            return PrimerApplication.mContext.getString(getNameRes());
        }
        ...
        public Drawable getDrawable() {
            return PrimerApplication.mContext.getResources().getDrawable(getDrawableRes());
        }

        public int getColor() {
            return PrimerApplication.mContext.getResources().getColor(getColorRes());
        }
