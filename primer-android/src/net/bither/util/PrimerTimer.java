...
import net.bither.bitherj.api.GetFiatSupplyApi;
...
public class PrimerTimer {
    ...
    public PrimerTimer(Context context) {
    ...
    private void getExchangeTicker() {
        try {
            ...
            GetFiatSupplyApi getFiatSupplyApi = new GetFiatSupplyApi();
            getFiatSupplyApi.handleHttpGet();
            AppSharedPreference.getInstance().setTotalSupply(getFiatSupplyApi.getSupply());
    ...
    private void notif(final MarketType marketType, boolean isHigher,
        ...
        intent.putExtra(PrimerSetting.INTENT_REF.MARKET_INTENT, marketType);
        intent.putExtra(PrimerSetting.INTENT_REF.INTENT_FROM_NOTIF, true);
        ...
        contentText = Utils.format(contentText, PrimerSetting.getMarketName(marketType));
        ...
        SystemUtil.nmNotifyDefault(nm, context,
                PrimerSetting.NOTIFICATION_ID_NETWORK_ALERT, intent,
