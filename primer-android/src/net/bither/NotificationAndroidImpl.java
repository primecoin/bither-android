...
public class NotificationAndroidImpl implements NotificationService {
    ...
    public void sendBroadcastSyncSPVFinished(boolean isFinished) {
        if (isFinished) {
            ...
            PrimerApplication.mContext.sendStickyBroadcast(broadcast);
        }
    }
    ...
    public void removeBroadcastSyncSPVFinished() {
        PrimerApplication.mContext.removeStickyBroadcast(new Intent(
    ...
    public void removeAddressLoadCompleteState() {
        PrimerApplication.mContext.removeStickyBroadcast(new Intent(ACTION_ADDRESS_LOAD_COMPLETE_STATE));
    }
    ...
    public void sendConnectedChangeBroadcast(String connectedChangeBroadcast, boolean isConnected) {
        ...
        PrimerApplication.mContext.sendBroadcast(intent);
    }
    ...
    public void removeAddressTxLoading() {
        PrimerApplication.mContext.removeStickyBroadcast(new Intent(ACTION_ADDRESS_TX_LOADING_STATE));
    }
}
