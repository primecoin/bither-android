...
public class Check {
	...
	public void setTitle(int resouceId) {
		this.mTitle = PrimerApplication.mContext.getString(resouceId);
	}
	...
	public void setTitleFailed(int resourceId) {
		this.mTitleFailed = PrimerApplication.mContext.getString(resourceId);
	}
	...
	public void setTitleChecking(int resourceId) {
		this.mTitleChecking = PrimerApplication.mContext.getString(resourceId);
	}
