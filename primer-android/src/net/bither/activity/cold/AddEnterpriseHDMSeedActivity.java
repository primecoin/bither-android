...
public class AddEnterpriseHDMSeedActivity extends SwipeRightFragmentActivity {
    ...
    private View.OnClickListener optionsClick = new DialogWithActions.DialogWithActionsClickListener() {
        ...
        protected List<DialogWithActions.Action> getActions() {
            ...
            actions.add(new DialogWithActions.Action(R.string
                ...
                public void run() {
                    ...
                    intent.putExtra(PrimerSetting.INTENT_REF.QRCODE_TYPE, PrimerSetting.QRCodeType.Bither);
