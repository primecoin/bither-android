...
import org.primer.model.Check.CheckListener;
import org.primer.preference.AppSharedPreference;
import org.primer.ui.base.CheckHeaderView;
import org.primer.ui.base.CheckHeaderView.CheckHeaderViewListener;
import org.primer.ui.base.WrapLayoutParamsForAnimator;
import org.primer.ui.base.dialog.DialogAddressFull;
import org.primer.util.CheckUtil;
    ...
    private class CheckPoint implements CheckListener {
        ...
        public boolean isHDAccountCold() {
            return Utils.compareString(address, HDAccount.HDAccountMonitoredPlaceHolder)
                    && AppSharedPreference.getInstance().getAppMode() == PrimerjSettings.AppMode
                    .COLD;
        }
