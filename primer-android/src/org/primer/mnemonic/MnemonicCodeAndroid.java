...
public class MnemonicCodeAndroid extends MnemonicCode {
    ...
    private InputStream getMnemonicWordListRawResource(MnemonicWordList wordList) {
        switch (wordList) {
            case English:
                return PrimerApplication.mContext.getResources().openRawResource(R.raw.mnemonic_wordlist_english);
            case ZhCN:
                return PrimerApplication.mContext.getResources().openRawResource(R.raw.mnemonic_wordlist_zh_cn);
            case ZhTw:
                return PrimerApplication.mContext.getResources().openRawResource(R.raw.mnemonic_wordlist_zh_tw);
        }
        return PrimerApplication.mContext.getResources().openRawResource(R.raw.mnemonic_wordlist_english);
    }
