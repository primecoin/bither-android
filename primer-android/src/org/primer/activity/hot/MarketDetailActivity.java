...
import org.primer.runnable.GetExchangeDepthRunnable;
import org.primer.runnable.GetKLineRunnable;
import org.primer.runnable.HandlerMessage;
import org.primer.ui.base.DropdownMessage;
import org.primer.ui.base.KlineDetailView;
import org.primer.ui.base.MarketDepthDetailView;
import org.primer.ui.base.SwipeRightActivity;
import org.primer.ui.base.dialog.DialogMarketDetailOption;
import org.primer.ui.base.dialog.DialogMarketDetailOption.MarketDetailDialogDelegate;
...
import org.primer.util.DateTimeUtil;
...
public class MarketDetailActivity extends SwipeRightActivity implements OnCheckedChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null && intent.hasExtra(PrimerSetting.INTENT_REF.MARKET_INTENT)) {
            marketType = (MarketType) intent.getSerializableExtra(PrimerSetting.INTENT_REF
                    .MARKET_INTENT);
        }
        boolean isFromNotif = false;
        if (intent != null && intent.hasExtra(PrimerSetting.INTENT_REF.INTENT_FROM_NOTIF)) {
            isFromNotif = intent.getBooleanExtra(PrimerSetting.INTENT_REF.INTENT_FROM_NOTIF, false);
        }
        ...
        if (marketType == null) {
            ...
            initView();
            if (isFromNotif && PrimerApplication.hotActivity != null) {
                chartKline.postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        if (PrimerApplication.hotActivity != null) {
                            PrimerApplication.hotActivity.notifPriceAlert(marketType);
                        }
                    }
                }, 500);
