...
import org.primer.R;
import org.primer.adapter.TransactionListAdapter;
...
import org.primer.ui.base.AddressDetailHeader;
...
import org.primer.ui.base.TransactionListItem;
import org.primer.ui.base.dialog.DialogAddressAlias;
import org.primer.ui.base.dialog.DialogAddressWatchOnlyOption;
import org.primer.ui.base.dialog.DialogAddressWithPrivateKeyOption;
...
public class AddressDetailActivity extends SwipeRightFragmentActivity implements
    ...
    protected void initAddress() {
        if (getIntent().getExtras().containsKey(PrimerSetting.INTENT_REF
            ...
            addressPosition = getIntent().getExtras().getInt(PrimerSetting.INTENT_REF
                    .ADDRESS_POSITION_PASS_VALUE_TAG);
            boolean hasPrivateKey = getIntent().getExtras().getBoolean(PrimerSetting.INTENT_REF
                    .ADDRESS_HAS_PRIVATE_KEY_PASS_VALUE_TAG, false);
            boolean isHDM = getIntent().getExtras().getBoolean(PrimerSetting.INTENT_REF
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == PrimerSetting.INTENT_REF.SEND_REQUEST_CODE && resultCode == RESULT_OK) {
