...
import org.primer.R;
import org.primer.primerj.api.BccBroadCastApi;
import org.primer.primerj.api.BccHasAddressApi;
import org.primer.primerj.api.GetBcdBlockHashApi;
...
public class SplitBCCHDAccountMonitoredSendActivity extends SplitBCCSendActivity implements DialogHdSendConfirm
    ...
    private void qrCodeTxTranscation(String...blockHash) {
        ...
        intent.putExtra(PrimerSetting.INTENT_REF.QR_CODE_STRING, QRCodeTxTransport.getSplitCoinHDAccountMonitoredUnsignedTx(txs, toAddress, (HDAccount) address, splitCoin, blockHash));
