...
public class SignTxActivity extends SwipeRightActivity implements
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == PrimerSetting.INTENT_REF.SCAN_REQUEST_CODE
        ...
        Thread thread = new Thread() {
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        dp.dismiss();
                        Intent intent = new Intent(SignTxActivity.this, PrimerQRCodeActivity.class);
                        intent.putExtra(PrimerSetting.INTENT_REF.QR_CODE_STRING, r);
                        intent.putExtra(PrimerSetting.INTENT_REF.TITLE_STRING, getString(R.string.signed_transaction_qr_code_title));
