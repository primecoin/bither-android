...
import org.primer.R;
import org.primer.activity.hot.AddHotAddressPrivateKeyActivity;
import org.primer.adapter.cold.ColdFragmentPagerAdapter;
...
import org.primer.fragment.cold.CheckFragment;
...
import org.primer.ui.base.dialog.DialogColdAddressCount;
...
import org.primer.ui.base.dialog.ProgressDialog;
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == PrimerSetting.INTENT_REF.SCAN_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            if (addresses != null && addresses.size() > 0) {
                ...
                if (data.getExtras().getBoolean(PrimerSetting.INTENT_REF
...
//                Intent intent = new Intent(ColdActivity.this, AddColdAddressActivity.class);
    ...
    protected void onDestroy() {
        PrimerApplication.coldActivity = null;
