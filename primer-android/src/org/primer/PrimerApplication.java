...
import org.primer.db.AddressDatabaseHelper;
import org.primer.db.AndroidDbImpl;
import org.primer.db.TxDatabaseHelper;
import org.primer.exception.UEHandler;
...
import org.primer.xrandom.LinuxSecureRandom;
...
public class PrimerApplication extends Application {
    ...
    private static org.slf4j.Logger log = LoggerFactory.getLogger(PrimerApplication.class);
    private static PrimerApplication mPrimerApplication;
    ...
    public static PrimerApplication getBitherApplication() {
        return mPrimerApplication;
    }
...
//    }
    ...
    private void upgrade() {
        ...
        if (updateCode == -1){
            appSharedPreference.setTransactionFeeMode(PrimerjSettings.TransactionFeeMode.Normal);
