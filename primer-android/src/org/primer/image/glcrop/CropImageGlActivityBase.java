 ...
 */
package org.primer.image.glcrop;
...
import org.primer.R;
import org.primer.animation.FlipAndZoomAnimation;
...
import org.primer.util.NativeUtil;
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (Utils.compareString(intent.getAction(), Intent.ACTION_SEND)) {
            if (intent.getExtras().containsKey("android.intent.extra.STREAM")) {
                if (PrimerApplication.initialActivity != null) {
                    PrimerApplication.initialActivity.finish();
                }
