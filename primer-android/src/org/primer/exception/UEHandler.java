...
public class UEHandler implements UncaughtExceptionHandler {
    ...
    private static String getLogCacheDir() {
        String logDir;
        if (PrimerApplication.mContext.getExternalCacheDir() != null) {
            logDir = PrimerApplication.mContext.getExternalCacheDir().getAbsolutePath();
        } else {
            logDir = PrimerApplication.mContext.getCacheDir().getAbsolutePath();
        }
