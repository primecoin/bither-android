...
package org.primer.adapter.hot;
...
import org.primer.R;
import org.primer.activity.hot.AddHDMAddressActivity;
import org.primer.activity.hot.AddressDetailActivity;
import org.primer.activity.hot.EnterpriseHDMAddressDetailActivity;
import org.primer.activity.hot.HDAccountDetailActivity;
import org.primer.activity.hot.HDAccountMonitoredDetailActivity;
import org.primer.activity.hot.SplitBCCHDAccountMonitoredSendActivity;
import org.primer.activity.hot.SplitBCCHDAccountSendActivity;
import org.primer.activity.hot.SplitBCCSendActivity;
import org.primer.activity.hot.SplitBccColdWalletSendActivity;
...
import org.primer.ui.base.ObtainBCCListItemView;
import org.primer.ui.base.PinnedHeaderAddressExpandableListView;
import org.primer.ui.base.PinnedHeaderExpandableListView.PinnedExpandableListViewAdapter;
import org.primer.ui.base.dialog.DialogAddressWatchOnlyLongClick;
import org.primer.ui.base.dialog.DialogAddressWithShowPrivateKey;
import org.primer.ui.base.dialog.DialogHDMAddressOptions;
import org.primer.ui.base.dialog.DialogHDMSeedOptions;
import org.primer.ui.base.dialog.DialogHdAccountOptions;
    ...
    private class GroupViewHolder {
        ...
        private void hdmAdd() {
            ...
            activity.startActivityForResult(new Intent(activity, AddHDMAddressActivity.class),
                    PrimerSetting.INTENT_REF.SCAN_REQUEST_CODE);
            ...
            if (!clicked) {
                ...
                if (isSplitCoinAddress) {
                    if (isSyncComplete(a)) {
                        ...
                        intent.putExtra(SplitCoinKey, splitCoin);
                        intent.putExtra(PrimerSetting.INTENT_REF.ADDRESS_POSITION_PASS_VALUE_TAG, position);
                        intent.putExtra(PrimerSetting.INTENT_REF.ADDRESS_HAS_PRIVATE_KEY_PASS_VALUE_TAG,
                                isPrivate);
                        intent.putExtra(PrimerSetting.INTENT_REF.ADDRESS_IS_HDM_KEY_PASS_VALUE_TAG, isHDM);
                        activity.startActivityForResult(intent,
                                SplitBccSelectAddressActivity.SPLIT_BCC_HDACCOUNT_REQUEST_CODE);
                    }
                } else {
