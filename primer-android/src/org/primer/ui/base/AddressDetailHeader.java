...
import org.primer.activity.hot.EnterpriseHDMSendActivity;
import org.primer.activity.hot.GenerateUnsignedTxActivity;
import org.primer.activity.hot.HDAccountMonitoredSendActivity;
import org.primer.activity.hot.HDAccountSendActivity;
import org.primer.activity.hot.HdmSendActivity;
...
import org.primer.qrcode.Qr;
import org.primer.runnable.ThreadNeedService;
import org.primer.service.BlockchainService;
import org.primer.ui.base.dialog.DialogBalanceDetail;
import org.primer.ui.base.dialog.DialogFragmentFancyQrCodePager;
        ...
        public void onClick(View v) {
            if (address != null) {
                ...
                if (address.isHDM() || address.hasPrivKey()) {
                    ...
                    intent.putExtra(PrimerSetting.INTENT_REF.ADDRESS_POSITION_PASS_VALUE_TAG,
                            addressPosition);
                    intent.putExtra(PrimerSetting.INTENT_REF.ADDRESS_IS_HDM_KEY_PASS_VALUE_TAG,
                            address.isHDM());
                    activity.startActivityForResult(intent, PrimerSetting.INTENT_REF
                            .SEND_REQUEST_CODE);
                } else {
