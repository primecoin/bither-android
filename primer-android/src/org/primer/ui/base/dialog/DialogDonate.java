...
import org.primer.activity.hot.SelectAddressToSendActivity;
...
public class DialogDonate extends CenterDialog implements OnDismissListener, OnShowListener {
    ...
    private class ListItemClick implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            intent.putExtra(SelectAddressToSendActivity.INTENT_EXTRA_ADDRESS, PrimerjSettings.DONATE_ADDRESS);
            intent.putExtra(PrimerSetting.INTENT_REF.ADDRESS_IS_HDM_KEY_PASS_VALUE_TAG,
                    address.address.isHDM());
            if (address.balance > PrimerSetting.DONATE_AMOUNT) {
                intent.putExtra(SelectAddressToSendActivity.INTENT_EXTRA_AMOUNT, PrimerSetting.DONATE_AMOUNT);
            } else {
