...
public class Depth implements Serializable {
    ...
    private PrimerjSettings.MarketType marketType;
    ...
    public static Depth formatJsonOfMarketDepth(PrimerjSettings.MarketType marketType,
    ...
    public PrimerjSettings.MarketType getMarketType() {
        return marketType;
    }

    public void setMarketType(PrimerjSettings.MarketType marketType) {
