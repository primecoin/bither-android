...
import org.primer.primerj.api.GetExchangeTrendApiNew;
import org.primer.model.TrendingGraphicData;
...
public class TrendingGraphicUtil {
    ...
    public static TrendingGraphicData getTrendingGraphicData(
        ...
        TrendingGraphicData trendingGraphicData = trendingDatas[PrimerjSettings.getMarketValue(marketType)];
...
//                    GetExchangeTrendApi getExchangeTrendApi = new GetExchangeTrendApi(marketType);
                    ...
                    final TrendingGraphicData trendingGraphicData = TrendingGraphicData.formatNew(jsonArray, PrimerjSettings.getMarketValue(marketType));
                    trendingDatas[PrimerjSettings.getMarketValue(marketType)] = trendingGraphicData;
