...
public class NetworkUtil {
    ...
    public static boolean isConnected() {
        ...
        try {
            ConnectivityManager ConnectivityManager = (ConnectivityManager) PrimerApplication
                    .mContext
    ...
    public static NetworkType isConnectedType() {
        try {
            ConnectivityManager mConnectivity = (ConnectivityManager) PrimerApplication.mContext
                    .getSystemService(Context.CONNECTIVITY_SERVICE);
