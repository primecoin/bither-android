...
import org.primer.ui.base.dialog.DialogMonitorAddressesValidation;
 ...
 */
public class MonitorPrimerColdUtil {
    public interface MonitorPrimerColdUtilDelegate {
    ...
    private MonitorPrimerColdUtilDelegate delegate;

    public MonitorPrimerColdUtil(Fragment fragment, MonitorPrimerColdUtilDelegate delegate) {
        this(null, fragment, delegate);
    }

    public MonitorPrimerColdUtil(Activity activity, MonitorPrimerColdUtilDelegate delegate) {
        this(activity, null, delegate);
    }

    public MonitorPrimerColdUtil(Activity activity, Fragment fragment,
                                 MonitorPrimerColdUtilDelegate delegate) {
    ...
    public void scan() {
        ...
        intent.putExtra(PrimerSetting.INTENT_REF.TITLE_STRING, activity.getString(R.string
                .scan_for_all_addresses_in_bither_cold_title));
        if (fragment != null) {
            fragment.startActivityForResult(intent, PrimerSetting.INTENT_REF
                    .SCAN_ALL_IN_BITHER_COLD_REUEST_CODE);
        } else {
            activity.startActivityForResult(intent, PrimerSetting.INTENT_REF
                    .SCAN_ALL_IN_BITHER_COLD_REUEST_CODE);
        }
    }
