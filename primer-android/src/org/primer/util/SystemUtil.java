...
public class SystemUtil {
    ...
    public synchronized static PackageInfo packageInfo() {
        if (packageInfo == null) {
            try {
                packageInfo = PrimerApplication.mContext.getPackageManager()
                        .getPackageInfo(
                                PrimerApplication.mContext.getPackageName(), 0);
    ...
    public static String getIMEI() {
        return ((TelephonyManager) PrimerApplication.mContext
    ...
    public static int getAppVersionCode() {
        try {
            ...
            PackageManager pm = PrimerApplication.mContext.getPackageManager();
    ...
    public static void gotoWirelessSetting(Activity activity) {
        if (android.os.Build.VERSION.SDK_INT > 10) {
            activity.startActivityForResult(new Intent(
                    ...
                    PrimerSetting.INTENT_REF.WIRELESS_SETTINGS_CODE
            );
        } else {
            activity.startActivityForResult(new Intent(
