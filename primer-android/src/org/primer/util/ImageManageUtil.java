...
import org.primer.ui.base.listener.IGetAvatarListener;
...
public class ImageManageUtil {
    ...
    public static int getScreenWidth() {
        return PrimerApplication.mContext.getResources().getDisplayMetrics().widthPixels;
    }
    ...
    public static void getAvatarForFancyQrCode(IGetAvatarListener getAvatarListener) {
        ...
        Resources res = PrimerApplication.mContext.getResources();
    ...
    public static final int dip2pix(float dip) {
        final float scale = PrimerApplication.mContext.getResources()
